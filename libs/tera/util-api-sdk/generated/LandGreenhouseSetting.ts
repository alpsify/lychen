...
export class LandGreenhouseSetting<SecurityDataType = unknown> {
   ...
   * @name ApiLandGreenhouseSettingsUlidGet
   ...
   */
  apiLandGreenhouseSettingsUlidGet = (ulid: string, params: RequestParams = {}) =>
   ...
   *
   * @tags LandGreenhouseSetting
   * @name ApiLandGreenhouseSettingsUlidPatch
   ...
   */
  apiLandGreenhouseSettingsUlidPatch = (
    ulid: string,

	...
	variants: {
		variant: {
			[PATTERN_BACKGROUND_VARIANT.Grid]:
				'bg-[linear-gradient(to_right,rgb(var(--color-on-surface)/0.3)_1px,transparent_1px),linear-gradient(to_bottom,rgb(var(--color-on-surface)/0.3)_1px,transparent_1px)]',
			[PATTERN_BACKGROUND_VARIANT.Dot]: 'bg-[radial-gradient(rgb(var(--color-on-surface)/0.3)_1px,transparent_1px)]',
			[PATTERN_BACKGROUND_VARIANT.BigDot]: 'bg-[radial-gradient(rgb(var(--color-on-surface)/0.3)_3px,transparent_3px)]',
		},
		size: {
			xs: 'bg-[size:8px_8px]',
...
export const patternBackgroundMaskVariants = cva('bg-surface', {
	variants: {
		mask: {

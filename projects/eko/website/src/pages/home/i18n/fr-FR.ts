export default {
  ...
  hero: {
    ...
    description:
      "Eko connecte méthaniseurs, collectivités et citoyens pour une gestion durable des biodéchets. Suivez les flux, réduisez les émissions et participez à la production d'énergie verte.",
    button: {
      features: {

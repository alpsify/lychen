<template>
  ...
  >
    ...
    <template #header><LychenLogoFull class="h-10" /></template>
    <template #mobile>
      <TheNavigationMobile />
    </template>
...
import { APP_STATE } from '@lychen/novi-util-constants/App';
import { defineAsyncComponent } from 'vue';
import { TRANSLATION_KEY, messages } from '@lychen/novi-ui-i18n';

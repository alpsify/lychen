...
class LandGreenhouseSecurityTest extends AbstractApiTestCase
{
    ...
    public function testPatch()
    {
        ...
        $this->browser()->actingAs($context1->owner)
            ->patch($this->getIriFromResource($context1->landGreenhouses[0]), ['json' => ['land' => $this->getIriFromResource($context2->land)]])
            ->assertSuccessful();
    ...
    public function testCollection()
    {
        ...
        $this->browser()
            ->get('/api/land_greenhouses', ['query' => ['land' => $this->getIriFromResource($context1->land)]])
            ->assertStatus(401);
        ...
        $this->addMember($context1, [$landRole]);
        $this->browser()->actingAs($context1->landMembers[0]->getPerson())
            ->get('/api/land_greenhouses', ['query' => ['land' => $this->getIriFromResource($context1->land->_real())]])
            ->assertStatus(403);
    }
}

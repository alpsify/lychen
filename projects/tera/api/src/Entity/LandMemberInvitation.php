...
#[ApiResource]
#[Post(securityPostDenormalize: "is_granted('" . LandMemberInvitationVoter::POST . "', object)")]
#[Patch(security: "is_granted('" . LandMemberInvitationVoter::PATCH . "', previous_object)")]
#[Patch(

...
readonly class ZitadelUserProvider implements UserProviderInterface
{
    ...
    public function __construct(private LoggerInterface $logger, private OIDC $OIDC, private PersonRepository $personRepository, private EntityManagerInterface $entityManager)
    {
    }
    ...
    {
        $response = $this->OIDC->introspectToken($identifier);

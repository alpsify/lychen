export default {
  ...
  bento: {
    ...
    local_value: {
      title: 'Valorisé le',
      keyword: 'local',
      subtitle: 'via le numérique',
    },
    data_ownership: {
      title: 'Vous êtes propriétaire de vos données',
      description: 'Assurez la transparence et le contrôle sur vos données personnelles.',
    },
    accessibility: {
      title: 'Accessibilité',
      subtitle: 'Fluidité et modernité',
    },
    citizen_change: {
      title: 'Changements citoyens',
    },
    applications: {
      title: 'Applications',
      subtitle: 'Inter-connectées',
    },
    sustainable_development: {
      title: 'Basé sur les',
      sdg_number: '17',
      subtitle: 'ODD européens',
    },
    sponsorship: {
      title: 'Sponsor',
      description: "Plutôt qu'investisseur",
    },
    ethics_inclusion: {
      title: 'Ethique & inclusif',
    },
    compromise: {
      title: '0',
      subtitle: 'compromis',
    ...
    communication: {
      title: 'Faire communiquer les acteurs du territoire',
    },
    team: {
      title: 'Petite équipe, grand résultat',
    },
    transparency: {
      title: 'Transparence',
  ...
  presentation: {
    ...
    description:
      "En intégrant des initiatives telles que l'agriculture biologique, le développement de la biodiversité, la gestion des déchets organiques et la sécurité alimentaire, la plateforme vise à transformer nos pratiques agricoles et alimentaires.",
    second_description:

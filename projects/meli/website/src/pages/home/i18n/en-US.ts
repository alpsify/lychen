export default {
  ...
  hero: {
    ...
    description:
      'Meli provides comprehensive tools to manage your apiaries and optimize your harvests. Connect with other beekeeping stakeholders and discover the secrets of this fascinating activity.',
    button: {
      features: {
        label: 'See Features',
      },
